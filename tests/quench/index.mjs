...
import { registerCharmTreeBuilder, registerCharmTreeDialogIntegration, registerCharmTreeDialogFairfolk } from "./charm-tree-dialog.mjs";
...
import { registerFairfolkSheet }   from "./sheets/fairfolk-sheet.mjs";
...
Hooks.once("quenchReady", async quench => {
  ...
  quench.registerBatch("exalted2e.charmTree.fairfolk",              registerCharmTreeDialogFairfolk,      { displayName: "EX2E: Charm Tree Dialog — Fair Folk support" });
  ...
  quench.registerBatch("exalted2e.fairfolk.sheet",   registerFairfolkSheet,   { displayName: "Fair Folk sheet — caste assignment + render" });
